...
| ADR-0011 Spike Gate: TipTap Markdown round-trip not yet validated | FR-003 | BE [#2](https://github.com/jtarriela/cortex-os-backend/issues/2) | Open — Phase 0.5 (Spike #2 pending) |
